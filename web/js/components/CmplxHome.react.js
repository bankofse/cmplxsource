        ...
        <div className="content-wrapper">
          <div className="content">
            <div className="pure-g">
              ...
              <MediaBox header="Plays Nice" body="By using our own curancy, octothorpes, and running on a offshore server bank. We avoid regulations that would otherwise slow us down." />
            </div>
          </div>
